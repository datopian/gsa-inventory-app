    ...
    render() {
        return (
            <div className="app_navigation">
                ...
                <div className={`navsec ${this.props.currentStep==2 ? 'active' : ''}`} onClick={() => this.props.handleSteps(2)} >
                    <label>Additional Metadata</label>
                </div>
                <div className={`navsec ${this.props.currentStep==3 ? 'active' : ''}`} onClick={() => this.props.handleSteps(3)} >
